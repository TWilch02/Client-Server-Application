...
public class Application1 extends JFrame implements ActionListener {
	...
	public Application1() {
		...
		URLBox.addItem("project3.properties");
        URLBox.addItem("bikedb.properties");
		contentPane.add(URLBox);
		
		
		userBox.setBounds(109, 78, 142, 22);
		userBox.addItem("client1.properties");
		userBox.addItem("client2.properties");
		userBox.addItem("root.properties");

		
		contentPane.add(userBox);
		
		JLabel lblNewLabel_5 = new JLabel("DB Connection Area");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblNewLabel_5.setBounds(131, 11, 120, 14);
